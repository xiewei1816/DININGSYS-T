...
@Repository
public interface DgItemForWeekMapper  extends GenericDao<DgItemForWeek,Integer>{
    int deleteByPrimaryKey(Integer id);

    int insert(DgItemForWeek record);

    int insertSelective(DgItemForWeek record);

    DgItemForWeek selectByPrimaryKey(Integer id);

    int updateByPrimaryKeySelective(DgItemForWeek record);

    int updateByPrimaryKey(DgItemForWeek record);
	 ...
	 * @param listObj
	 */
    void insertBatch(@Param("listObj") List<DgItemForWeek> listObj);
} 