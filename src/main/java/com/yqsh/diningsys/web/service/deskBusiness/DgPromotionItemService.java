...
public interface DgPromotionItemService extends GenericService<DgPromotionItem,Integer>{
    ...
    int savePromItem(String data);
    void synPromItem(List<DgPromotionItem> listPromItem);
}
