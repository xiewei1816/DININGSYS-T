(function (a) {
        ...
        this.each(function () {
            ...
            if (d != "" && h != true) {
                if(e.showRemoveTag){
                    ...
                    a("<span>").addClass("tag").append(a("<span>").text(d)).insertBefore("#" + f + "_addTag");
                }
                g.push(d);
                a("#" + f + "_tag").val("");
                if (e.focus) {
    ...
    a.fn.tagsInput = function (d) {
        ...
        this.each(function () {
            ...
            if (a(f.real_input).val() != "") {
                a.fn.tagsInput.importTags(a(f.real_input), a(f.real_input).val(),e.showRemoveTag)
            }
            if (e.interactive) {
                ...
                if (e.autocomplete_url != undefined) {
                    ...
                    if (jQuery.Autocompleter !== undefined) {
                        ...
                        a(f.fake_input).bind("result", f, function (b, c, f) {
                            if (c) {
                                a("#" + d).addTag(c[0] + "", {focus: true, unique: e.unique, showRemoveTag:e.showRemoveTag})
                            }
                        })
                    } else if (jQuery.ui.autocomplete !== undefined) {
                        a(f.fake_input).autocomplete(autocomplete_options);
                        a(f.fake_input).bind("autocompleteselect", f, function (b, c) {
                            a(b.data.real_input).addTag(c.item.value, {focus: true, unique: e.unique, showRemoveTag:e.showRemoveTag});
                            return false
                        })
                    }
                } else {
    ...
    a.fn.tagsInput.importTags = function (d, e,showRemoveTag) {
        a(d).val("");
        var f = a(d).attr("id");
        var g = e.split(b[f]);
        for (i = 0; i < g.length; i++) {
            a(d).addTag(g[i], {focus: false, callback: false,showRemoveTag:showRemoveTag})
        }
        if (c[f] && c[f]["onChange"]) {
            var h = c[f]["onChange"];
            h.call(d, d, g[i])
