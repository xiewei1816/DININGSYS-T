...
<script>
        ...
        var setting = {
            ...
            callback:{
                ...
                onClick:function (event, treeId, treeNode) {
                    ...
                    var url = 'DININGSYS/settlementWay/selectAllItemFileType?parentId='+nodesId+'&type='+type+'&flag=2&ids='+itemIds;

                    jQuery("#itemFileTypeTable").jqGrid('setGridParam',{url:url}).trigger("reloadGrid");
                }
            },
            async: {
                enable: true,
    ...
    function initWxTable(){
        ...
        $("#itemFileTypeTable").jqGrid({
            url: 'DININGSYS/settlementWay/selectAllItemFileType?parentId='+nodesId+'&type='+type+'&flag=2&ids='+itemIds,
            datatype: "JSON",
