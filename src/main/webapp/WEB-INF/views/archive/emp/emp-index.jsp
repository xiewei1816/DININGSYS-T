...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="app/js/DININGSYS/archive/emp/emp.js" ></script>
	...
	<body>
		<div class="wrapper animated fadeInUp">
			...
			<div class="btn-toolbar">
				...
				<span id="resetPwd" class="greenbtn"><i class="fa fa-edit"></i>密码重置</span>
			</div>
	    ...
	    <jsp:include page="emp-edit.jsp"></jsp:include>
	</body>
</html>
