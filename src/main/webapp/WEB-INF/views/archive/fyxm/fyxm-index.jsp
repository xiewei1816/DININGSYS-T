...
<html>
	<head>
	    ...
	    <script src="app/js/DININGSYS/archive/fyxm/fyxm.js"></script>
	...
	<body>
		<div class="wrapper animated fadeInUp">
			...
			<div class="btn-toolbar">
				...
				<span id="gofylx" class="royalbtn"><i class="fa fa-list-alt"></i>费用类型</span>
	    ...
	    <jsp:include page="fyxm-edit.jsp"></jsp:include>
	</body>
</html>
