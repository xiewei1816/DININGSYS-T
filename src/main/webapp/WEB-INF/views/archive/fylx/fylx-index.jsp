...
<html>
	<head>
	    ...
	    <script src="app/js/DININGSYS/archive/fylx/fylx.js"></script>
	...
	<body>
					...
					<ul>
						<li>
							...
							<div class="form-group big-wid">
								<input type="text" class="form-control" id="fylxNum" name="fylxNum" />
							</div>
						</li>
						<li>
							<span class="title">名称</span>
							<div class="form-group big-wid">
								<input type="text" class="form-control" id="fylxName" name="fylxName" />
							</div>
						</li>
					</ul>
	    ...
	    <jsp:include page="fylx-edit.jsp"></jsp:include>
	</body>
</html>
