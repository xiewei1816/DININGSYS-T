...
<html>
	<head>
	    ...
	    <script src="app/js/DININGSYS/archive/zdbz/zdbz.js"></script>
	...
	<body>
					...
					<ul>
						<li>
							...
							<div class="form-group big-wid">
								<input type="text" class="form-control" id="zdbzNum" name="zdbzNum" />
							</div>
						</li>
					</ul>
	    ...
	    <jsp:include page="zdbz-edit.jsp"></jsp:include>
	</body>
</html>
