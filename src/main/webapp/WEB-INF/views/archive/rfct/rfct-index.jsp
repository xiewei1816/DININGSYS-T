...
<html>
	<head>
		<meta charset="UTF-8">
		<title>退菜原因类型维护管理</title>
		<jsp:include page="../../head.jsp"/>
	    <script src="app/js/DININGSYS/archive/rfct/rfct.js"></script>
	...
	<body>
					...
					<ul>
						<li>
							...
							<div class="form-group big-wid">
								<input type="text" class="form-control" id="rfctName" name="rfctName" />
							</div>
						</li>
						<li>
							<span class="title">编号</span>
							<div class="form-group big-wid">
								<input type="text" class="form-control" id="rfctCode"  name="rfctCode" />
							</div>
						</li>
					</ul>
	   ...
	   <jsp:include page="rfct-edit.jsp"></jsp:include>
	</body>
</html>
