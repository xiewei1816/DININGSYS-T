...
<script src="app/js/DININGSYS/archive/cgds/cgds-rank-item.js"></script>
<!-- 品项-排行 -->
<div id="menuTree" style="width: 200px; border: 1px solid #DDD; float: left;">
       <ul id="rankItemTree" class="ztree" style="width: 200px; height: 434px; overflow: auto;"></ul>
</div>
<div class="right-content" style="float: left;">
  	  <div style="text-align: center;">
  	  		<span>查找:<input type="text" id="rank-item-search" placeholder="编号，名称或助记符" onblur="goSearch(this.id)"/></span><br>
  			<span>可选内容:</span><span id="len-1">0</span>
  			<a id="sele-all-1" style="cursor:pointer;">全部选择</a>
  	  </div>
 		  <div class="jqGrid_wrapper jq-margin1">
          <table id="rank-item-table1"></table>
       </div>
       <div style="text-align: center;">
		 ...
		 <div class="jqGrid_wrapper jq-margin1">
          <table id="rank-item-table2"></table>
       </div>
</div>