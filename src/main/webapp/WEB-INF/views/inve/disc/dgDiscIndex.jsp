...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="app/js/DININGSYS/inve/dgDiscIndex.js"></script>
	...
	<body>
		<div class="wrapper animated fadeInUp">
				...
				<form class="query-pan" id="query-pan">
					<ul>
						...
						<div class="form-group biger-wid">
							<select name="wareID" id="wareID" class="form-control edit_wareID"
			...
			<div class="btn-toolbar">
				<span class="j-disc" ><i class="fa fa-file-o"></i>盘点</span>
			</div>
		...
		<jsp:include page="editDisc.jsp"></jsp:include>
	</body>
</html>
