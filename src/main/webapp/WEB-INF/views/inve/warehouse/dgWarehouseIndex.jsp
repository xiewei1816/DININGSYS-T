...
<html>
	...
	<body>
					...
					<ul>
						<li>
							...
							<div class="form-group big-wid">
								<input type="text" class="form-control" name="wareName" />
							</div>
						</li>
						<li>
	    ...
	    <div id="editPanel" style="display: none;" title="仓库信息">
	    		...
	    		<ul class="edit-contents animated fadeInUp">
	    			<li>
						...
						<div class="form-group biger-wid">
							<input placeholder="请输入仓库名称" type="text" class="form-control edit_wareName" maxlength="32" name="wareName" editype="val" dete="val" />
						</div>
					</li>
	    			<li>
	    				<span class="title">管理员</span>
						<div class="form-group bigest-wid">
							<input type="text" class="form-control edit_manageName" name="manageName" editype="val" maxlength="20" placeholder="请输入仓库管理员"/>
						</div>
	    			</li>
	    			<li>
	    ...
	    <script type="text/javascript" src="${ctx }/app/js/DININGSYS/inve/dgWarehouse.js"></script>
	</body>
</html>
