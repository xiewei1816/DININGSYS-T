...
<script>
    $(function ($) {
    	recommend_dish_add.pagerInit();
    	recommend_dish_add.ztreeInit();
    })
</script>
<div class="left-menu">
...
<div class="right-content">
	...
	<div class="sele">
		<span>可选内容:</span><span class="len-1">0</span> <a class="sele-all-1">全部选择</a>
	</div>
	<div class="jqGrid_wrapper jq-margin1">
		<table id="grid-table-4"></table>
	</div>
	<div class="sele">
		<span>已选内容:</span><span class="len-2">0</span> <a class="sele-all-2">全部取消</a>
	</div>
	<div class="jqGrid_wrapper jq-margin1">
