...
<script src="app/js/DININGSYS/deskBusiness/product_item/item_outof_stock.js"></script>
            ...
            <form class="form-horizontal" role="form" id="userImpDisForm">
				<div class="form-body">
				        <div class="form-group" style="height: 30px">
	                        <label  class="col-md-3 control-label"><!--  <h5 style="margin-left: 15px;margin-top: 5px" value="0">共计:3个品项沽清</h5>--></label>
	                         <label class="radio-inline">
									  <input type="radio" name="mType" id="isALL" value='1' checked> 不指定
							</label>
							<label class="radio-inline">
									  <input type="radio" name="mType" id="isALL" value='2' > 按当前市别
							</label>
							<label class="radio-inline">
									  <input type="radio" name="mType" id="isALL" value='3' > 按营业日
							</label>
	                    </div>
	            </div>
            </form>
