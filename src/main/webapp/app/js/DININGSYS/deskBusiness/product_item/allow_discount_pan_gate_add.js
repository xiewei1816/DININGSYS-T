var dis_pan_gate_add = function () {
	function pagerInit()
    {
		...
		$("#grid-table-4").jqGrid({
	        url:path+"/DININGSYS/ProDiscountPan/getAllGate",
		...
		$("#grid-table-5").jqGrid({
	        url:path+"/DININGSYS/ProDiscountPan/getHaveGate",
	        datatype:"json", //数据来源，本地数据
	        mtype:"POST",//提交方式
	        height:150,//高度，表格高度。可为数值、百分比或'auto'
	        width:630,//这个宽度不能为百分比
	...
	var discounts_setting = {
		    ...
		    enable : true,//是否异步加载
	        url : path+'/DININGSYS/ProDiscountPan/getTreeGateNodes',//加载数据的url  /DININGSYS/ProDiscount/getTreeNodes
