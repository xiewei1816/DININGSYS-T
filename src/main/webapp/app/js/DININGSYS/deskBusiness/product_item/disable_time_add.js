var disable_time_add = function () {
	...
	function pagerInit()
    {
		...
		$("#grid-table-4").jqGrid({
	        url:path+"/DININGSYS/ProDiscountPan/getAllDish?disable=1&yxdz=0",
		...
		$("#grid-table-5").jqGrid({
	        url:path+"/DININGSYS/ProDiscountPan/getHaveDish?disable=1&yxdz=0",
	        datatype:"json", //数据来源，本地数据
	        mtype:"POST",//提交方式
	        height:150,//高度，表格高度。可为数值、百分比或'auto'
	        width:630,//这个宽度不能为百分比
