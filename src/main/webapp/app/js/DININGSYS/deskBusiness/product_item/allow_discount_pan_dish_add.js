	...
	function pagerInit()
    {
		...
		$("#grid-table-4").jqGrid({
			...
			ondblClickRow: function(id){ 
				...
				//双击行
		  		$("#grid-table-5").addRowData(id, getRow);
		...
		$("#grid-table-5").jqGrid({
			...
			ondblClickRow: function(id){ 
				 var grid = $("#grid-table-5");
		  		 getRow = grid.getRowData(id);//获取当前的数据行  
				//双击行
		  		$("#grid-table-4").addRowData(id, getRow);
	    ...
	    $(".sele-all-1").click(function(){
	  		...
	  		for(var i=0; i<len; i++){ 
		        ...
		        $("#grid-table-5").addRowData(colVal, getRow);
	    ...
	    $(".sele-all-2").click(function(){
	  		...
	  		for(var i=0; i<len; i++){ 
		        var getRow = grid.getRowData(ids[i]);//获取当前的数据行  
		        var colVal = getRow.id;
		        $("#grid-table-4").addRowData(colVal, getRow);
