var recommend_dish_add = function () {
	var treeNodeId='';
	function pagerInit()
    {
		...
		$("#grid-table-4").jqGrid({
	        url:path+"/DININGSYS/ProDiscountPan/getAllDish", //不用变用方案里面的方法加载所有数据
	...
	var discounts_setting = {
		    ...
		    enable : true,//是否异步加载
	        url : path+'/DININGSYS/ProDiscount/getTreeNodes',//加载数据的url  不用变,用方案里的方法，加载树，以及方法
