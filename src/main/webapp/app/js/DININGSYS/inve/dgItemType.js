$(function(){
	    		...
	    		$(".add").click(function(){
	    			pageUtil.addOper({
	    				...
	    				saveUrl : "saveItemType", 						//添加保存的地址(必要)。
	    		...
	    		$("#update").click(function(){
	    			pageUtil.updOper({
	    				...
	    				updUrl : "getItemTypeById",									//获取修改数据的后台地址(必要)。
	    		...
	    		$("#delb").click(function(){
	    			pageUtil.delOper({
	    				...
	    				url : "deleteItemType",										//删除数据提交的后台地址(必要)。
	    		...
	    		$("#" + pageUtil.tabId).getJqGrid({
	    			url : "getPageList",
	    			colM : "itemTypeNo,itemTypeName,remark,createDate",
	    			queryForm : "queryForm",
	    			colNames : "编码,名称,备注,创建时间",
