$(function(){
	    		...
	    		$(".add").click(function(){
	    			pageUtil.addOper({
	    				...
	    				saveUrl : "saveWarehouse", 						//添加保存的地址(必要)。
	    		...
	    		$("#update").click(function(){
	    			pageUtil.updOper({
	    				...
	    				updUrl : "getWarehouseById",									//获取修改数据的后台地址(必要)。
	    		...
	    		$("#delb").click(function(){
	    			pageUtil.delOper({
	    				...
	    				url : "deleteWarehouse",										//删除数据提交的后台地址(必要)。
	    		...
	    		$("#" + pageUtil.tabId).getJqGrid({
	    			url : "getPageList",
	    			colM : "wareNo,wareName,manageName,remark,createDate",
	    			queryForm : "queryForm",
	    			colNames : "编码,名称,管理人,备注,创建时间",
