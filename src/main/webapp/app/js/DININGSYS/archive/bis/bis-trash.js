$(function(){
	...
	$("#" + pageUtil.tabId).getJqGrid({
		url : "DININGSYS/archive/bis/getPageList?isDel=1",
		colM : "bisName,bisTime,bisOrganization",
		queryForm : "queryForm",
		colNames : "名称,开始时间,所属机构",
		colWid : {"id":40},
		formatter : {
		},
	...
	$("#reply").click(function(){
		...
		layer.confirm('请注意,你确定还原数据吗？', {
		  ...
		  btn : ['确定','取消'] //按钮
			  ...
			  jQuery.ajax({
					url : 'DININGSYS/archive/bis/replyBis',
					data : {"editIds":rowids + ""},
					type : "POST",
					dataType:"json",
	...
	$("#delete").click(function(){
		...
		layer.confirm('请注意,该功能删除的数据不可逆.你确定吗?', {
		  ...
		  btn : ['确定','取消'] //按钮
			  ...
			  jQuery.ajax({
					url : 'DININGSYS/archive/bis/deleteBis',
					data : {"editIds":rowids + ""},
					type : "POST",
					dataType:"json",
					error : function(request) {
